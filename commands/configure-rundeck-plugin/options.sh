...
# Created: Mon Nov 12 12:17:11 PST 2012
#
#/ usage: jenkins:configure-rundeck-plugin [ --restart|-r <false>] [ --jenkins-home|-j </var/lib/jenkins>] [ --rundeck-username|-r <admin>] [ --rundeck-password|-r <admin>] [ --rundeck-url|-r <http://localhost:4440>]
